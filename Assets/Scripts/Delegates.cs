...
public class Delegates : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        MathOperation3[] lookupTable = {
            MathOperation3.ADD, MathOperation3.SUB,
            MathOperation3.MUL, MathOperation3.DIV
        };

        int index = 0;
        Operation(a, b, lookupTable[index]);

        mathOperation1 = Functions.Add;
        Debug.Log(mathOperation1(a, b));

        mathOperation1 = Functions.Sub;
        Debug.Log(mathOperation1(a, b));

        mathOperation1 = Functions.Mul;
        Debug.Log(mathOperation1(a, b));

        mathOperation1 = Functions.Div;
        Debug.Log(mathOperation1(a, b));
        ...
        MathOperation1[] mathOperation1s = { Functions.Add, Functions.Sub, Functions.Mul, Functions.Div };
    ...
    float Operation(float a, float b, MathOperation3 type)
    {
        switch (type)
        {
            case MathOperation3.ADD: return Functions.Add(a, b);
            case MathOperation3.SUB: return Functions.Sub(a, b);
            case MathOperation3.MUL: return Functions.Mul(a, b);
            case MathOperation3.DIV: return Functions.Div(a, b);
        }
        return 0.0f;
    }
}
